        ...
        <div className="row" style={{ padding: "25px 0px 20px 0px" }}>
          <div className="col-md-9 col-xs-12">
            ...
            >
              ...
              <p>
                Xây dựng web trong thực tế với NodeJS & ExpressJS với cách chia
                sẻ chi tiết, tận tâm, dễ hiểu và chất giọng giàu sức sống của
                người chia sẻ
              </p>
                ...
                <a href="#">
                  <div className="col-md-12 col-xs-12">
                    <div>
                      ...
                      <span style="float: right; padding: 0px 20px 0px 20px">
                        06:27
                      </span>
                      <span style="float: right; padding: 0px 20px 0px 20px">
                        Học thử
                ...
                <a href="#">
                  <div className="col-md-12 col-xs-12">
                    <div>
                      ...
                      <span
                        style={{ float: "right", padding: "0px 20px 0px 20px" }}
                      >
                        06:27
                      </span>
                      <span
